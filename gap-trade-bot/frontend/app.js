        ...
        data() {
            ...
            brokerCardLoading: {},
                ...
                backtestConfig: {
                    ...
                    daySlippagePct: 0.1,
                    dayMaxReentry: 1,
                    // Direction + short-specific setups (RedBot experiment)
                    direction: 'long',
                    shortPmhReject: true,
                    shortVwapLoss: true,
                    shortLowerHigh: false,
                    shortBelowVwap: true,
                    shortBearishCandle: false,
                    shortVolumeSurge: false,
                    shortMinExtPct: 0,
                ...
                try {
                    ...
                    if (isDay) {
                        Object.assign(payload, {
                            ...
                            short_pmh_reject:        c.shortPmhReject,
                            short_vwap_loss:         c.shortVwapLoss,
                            short_lower_high:        c.shortLowerHigh,
                            short_below_vwap:        c.shortBelowVwap,
                            short_bearish_candle:    c.shortBearishCandle,
                            short_volume_surge:      c.shortVolumeSurge,
                            short_min_ext_pct:       c.shortMinExtPct,
